...
# - Added rbenv initialization (lines 23-31)
# - Added system dependency validation (lines 33-52)
# - Fixed database connectivity check to use nextgen_plaid_production (line 78)
# - Added Ruby version display for verification
#
...
# Start application
echo -e "${BLUE}═══════════════════════════════════════════════════${NC}"
echo -e "${GREEN}Starting nextgen-plaid in production mode...${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════${NC}"
echo ""

# Start Puma (web server)
echo -e "${YELLOW}Starting Puma web server on port 3000...${NC}"
