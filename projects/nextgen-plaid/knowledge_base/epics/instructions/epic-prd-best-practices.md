...
- **Feedback naming chaos** — `feedback.md`, `Feedback.md`, `junie-feedback.md`, `end-of-epic-feedback.md`, `feedback-junie.md`, `eric-grok.feedback.md`
...
knowledge_base/epics/
  ...
  │       │   └── review-{source}.md     # Reviews (e.g., review-junie.md, review-eric.md)
...
## Workflow
Junie: {model preference}. Branch: `feature/{branch-name}`.
...
`feedback.md`, `Feedback.md`, `junie-feedback.md`, `feedback-junie.md`, `end-of-epic-feedback.md`, `end-of-epic-report.md`, `eric-grok.feedback.md`, `review-feedback-epic-11.md`, `feedback-v2.md`, `final-feedback.md`, `0040-PRD-0-04-feedback.md`, `gap_feedback.md`
...
## Review Source
{Who reviewed: Eric, Junie, Grok, SAP, etc.}
...
| **Agent-Hub-12** | 🟡 Mixed: PRDs + EOPRDs + scratch + learning docs all in root | 🟢 Gold (has EOPRDs) | ✅ Junie feedback | ❌ Scattered | ⭐⭐⭐ |
...
| **AGENT-04** | ✅ Clean: epic + 4 PRDs | 🟡 Silver | ✅ Junie feedback | ❌ No tests | ⭐⭐⭐ |
